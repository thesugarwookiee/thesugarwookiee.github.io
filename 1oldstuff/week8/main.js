...
function buildStarshipCard(starship) {
    ...
    return `
        <section class="starship__Card noselect" id="${ id }">
            ...
            <p class="starship__content"><span class="title">Class:</span> ${ starship.starship_class }</p>
                <p class="starship__content"><span class="title">Cost:</span> ${ starship.cost_in_credits == "unknown" ? '' : '$'}${ numberWithCommas(starship.cost_in_credits) }</p>
                <p class="starship__content"><span class="title">Passengers:</span> ${ numberWithCommas(starship.passengers) }</p>
                <p class="starship__content"><span class="title">Crew:</span> ${ numberWithCommas(starship.crew) }</p>
                <p class="starship__content"><span class="title">Hypderdrive rating:</span> ${ starship.hyperdrive_rating }</p>
            </div>
        </section>
    `
}
